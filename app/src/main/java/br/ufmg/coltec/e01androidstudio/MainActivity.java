...
// TODO Reorganizar esse código ok
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnErro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                t.setGravity(Gravity.TOP, 0, 0);
                t.show();
// TODO Acrescentar um log de warning, indicando que o usuário clicou neste botão ok
                Log.w("MainActivity", "Você clicou no botão");
            }
        });
// TODO Acrescentar um log verbose, indicando que a Activity foi criada corretamente ok
        Log.i("MainActivity", "A Activity foi criada corretamente");
    }
}