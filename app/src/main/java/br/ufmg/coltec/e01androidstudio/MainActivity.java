    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        btnErro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.i("MainActivity", "Botão Apertado");
                Toast t = Toast.makeText(MainActivity.this, "Reprovado!", Toast.LENGTH_LONG); t.setGravity(Gravity.TOP, 0, 0); t.show();
// TODO Acrescentar um log de warning, indicando que o usuário clicou neste botão
                Log.w("MainActivity", "Você apertou o botão!");
            }
        });
// TODO Acrescentar um log verbose, indicando que a Activity foi criada corretamente
        Log.v("MainActivity", "Activity foi criado corretamente!");
    }
}